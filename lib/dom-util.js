...
class DomUtil {
	...
	/**
	 * Check whether the given object is a EventTarget.
	 * @param {*} obj Object to check.
	 * @return {boolean} `true` if the object is EventTarget.
	 */
	static isEventTarget(obj) {
	 ...
	 * @param {*} obj Object to check.
	 * @return {boolean} `true` if the object is Node.
	 */
	static isNode(obj) {
	...
	/**
	 * Check whether the given object is a Element.
	 */
	...
	/**
	 * Check whether the given object is a HTMLElement.
	 * @param {*} obj Object to check.
	 * @return {boolean} `true` if the object is HTMLElement.
	 */
	...
	static isTextNode(obj) {
		return !!(obj && obj.nodeType === Node.TEXT_NODE);
	}
